...
import com.chhetriSom.billingSoftware.entity.ItemEntity;
...
import com.chhetriSom.billingSoftware.repository.ItemRepository;
...
public class ItemServiceImpl implements ItemService {
    ...
    public void deleteItem(String itemId) {
        ...
        if (isFileDelete) {
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Unable to delete image from S3 bucket.");
        }
    }
}
